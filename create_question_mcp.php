	...
	<body>
        ...
        <div id="myform" style="margin-left:25%;padding:10px 50px;height:1000px;">
			<h3>Εκχώρηση Multiple Choice με πολλές σωστές απαντήσεις</h3>
			  ...
			  <form action="mcp1.php" method="post">
			  ...
			  <?php
                ...
                <br> 
			    <label for="qtext">Κείμενο Multiple Choice με πολλές σωστές απαντήσεις</label> <br>
			    <input type="text" id="qtext" name="qtext" placeholder="Κείμενο Multiple Choice με πολλές σωστές απαντήσεις" required>
				<br> 
			    ...
			    <input type="submit" value="Εισαγωγή απαντήσεων Multiple Choice με πολλές σωστές απαντήσεις">
