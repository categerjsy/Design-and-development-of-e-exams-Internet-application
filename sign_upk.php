...
<?php
		if (isset($_GET["msg"]) && $_GET["msg"] == 'failed_username') {
			print "<p style='color:red'>Παρακαλώ προσπαθήστε ξανά, το username που επιλέξατε χρησιμοποιείται από άλλο χρήστη.<p>";
		}
		else if (isset($_GET["msg"]) && $_GET["msg"] == 'failed_mail') {
			print "<p style='color:red'>Παρακαλώ προσπαθήστε ξανά, το email που επιλέξατε χρησιμοποιείται από άλλο χρήστη.<p>";
		}
